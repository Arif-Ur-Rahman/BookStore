  ...
  return (
    <div className="mt-6 my-3 p-3">
      <div className="card w-80 bg-base-100 shadow-xl hover:scale-105 duration-200 dark:bg-slate-900 dark:text-white dark:border">
        <figure>
          <img src={item.image} className="h-80 w-80" alt="Shoes" />
        </figure>
        <div className="card-body">
          ...
          <div className="card-actions justify-between">
            ...
            <div className="cursor-pointer px-2 py-0.5 rounded-full border-[2px] hover:text-white hover:bg-pink-500 p-1.5 duration-200">
              Buy Now
            </div>
          </div>
        </div>
